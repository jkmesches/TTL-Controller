...
const int FETPin = 12;      // the number of the MOSFET Gate pin
const int OutputLEDPin = 5;       // the number of the output indicator LED pin
const int TTLPin = 10;          // TTL pin
